...
export async function GET(req: Request) {
    try {
        ...
        const res = await axios.get(`${url}/messages/public?limit=${limit}&offset=${offset}`, {
        ...
        const data = res.data;
        console.log("this is hte data hoi in route.ts",data)
        if(data.rows == null){
            data.rows = []
        }
        ...
        console.log("this is error okei  : ", error)
